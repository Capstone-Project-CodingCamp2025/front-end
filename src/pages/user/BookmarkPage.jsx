    ...
    return (
      <div className="flex items-center justify-center min-h-[calc(100vh-10rem)]">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-lg text-gray-600">Memuat bookmark...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between mb-6">
            <p className="text-gray-600">
              <span className="font-semibold text-blue-600">{bookmarks.length}</span> destinasi tersimpan
            </p>
            ...
            {bookmarks.map((destination) => {
              ...
              return (
                <div
                  ...
                  className="relative bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group"
                >
                  {/* Image Section */}
                  <div
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      {destinationRating && (
                        <div className="flex items-center bg-yellow-100 px-2 py-1 rounded-full shrink-0">
                  ...
                  <button
                    ...
                    className="absolute z-10 p-2 text-white transition-all duration-200 bg-red-500 rounded-full shadow-lg top-3 right-3 hover:bg-red-600 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2"
